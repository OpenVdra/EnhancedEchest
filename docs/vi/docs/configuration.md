...
Bạn cũng có thể ghi đè kích thước rương cơ bản <strong>theo từng người chơi</strong> bằng quyền <code>enhancedechest.default_size.&lt;size&gt;</code> (luôn khả dụng, không cần cấu hình gì). Xem trang <a href="/vi/docs/permissions#default-size-permission">Quyền</a>.
