...
EnhancedEchest có thể nhập dữ liệu rương Ender sẵn có vào kho lưu trữ của riêng nó để không mất gì khi cài plugin. Hỗ trợ hai nguồn: rương Ender **vanilla** và plugin **AxVaults**.
