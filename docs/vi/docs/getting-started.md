...
<DocCard icon="ArrowRightLeft" title="Chuyển Dữ Liệu" link="/vi/docs/configuration/migration" desc="Nhập dữ liệu rương Ender vanilla sẵn có của người chơi." />

<DocCard icon="Globe" title="Đa Ngôn Ngữ" link="/vi/docs/configuration/language" desc="Mọi văn bản hiển thị cho người chơi đều có thể chỉnh sửa và dịch." />
