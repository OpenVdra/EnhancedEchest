...
Một số khối phức tạp như rương, cửa, hoặc cầu thang không thể dùng làm biểu tượng vì chúng không có hình ảnh đơn giản để hiển thị trên nút bấm. Tên vật phẩm trong danh sách chọn luôn tự động hiển thị đúng theo ngôn ngữ máy khách Minecraft của bạn. Tìm kiếm theo tên hiện hoạt động tốt nhất với tiếng Anh hoặc tiếng Việt; các ngôn ngữ máy khách khác sẽ tự động khớp theo tên tiếng Anh. Xem chi tiết ở trang <a href="/vi/docs/language#icon-picker-item-names">Ngôn Ngữ</a>.
